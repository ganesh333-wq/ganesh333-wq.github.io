...
function ContactForm() {
  ...
  return (
    <div className="w-full text-white">
      <div className="flex flex-col gap-4 rounded-xl border border-white/10 p-4 lg:p-6">
        ...
        <div className="flex flex-col items-center gap-2 mt-4">
          ...
          <button
            className="btn-shine flex items-center gap-2 rounded-full px-8 md:px-12 py-3 text-center text-xs md:text-sm font-medium uppercase tracking-wider no-underline md:font-semibold"
            role="button"
